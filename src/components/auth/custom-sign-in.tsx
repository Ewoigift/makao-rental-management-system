        ...
        <Tabs defaultValue={role} className="w-full mb-6">
          ...
          <TabsContent value="tenant" className="mt-4">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold mb-4">Tenant Sign In</h2>
              <p className="text-gray-600 mb-6">
                Access your rental dashboard, make payments, and submit maintenance requests.
              </p>
              <SignIn 
                appearance={{
                  elements: {
          ...
          <TabsContent value="landlord" className="mt-4">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold mb-4">Landlord Sign In</h2>
              <p className="text-gray-600 mb-6">
                Manage your properties, track payments, and handle maintenance requests.
              </p>
              <SignIn 
                appearance={{
                  elements: {
